...
/*
  ...
  중복될 경우에는 마지막에 선언된 onload가 실행이된다.
*/

/*
64. innerHTML 속성
  <div></div>나 <p></p>태그 안에 보여질 값을 가져오거나 
  출력을 할때 사용
...
// - 변수에 필요한 값을 할당하는데 유리하다.
// let data = ["pengguin2","suji2","irine2"];

// 보통을 데이터 처리를 
// let pengguin = data[0];
// let irine = data[2];

// Destucturing 은 아래와 같이 한다. 
// let[pengguin,,irine] = data;
// console.log(pengguin, irine);
 ...
 */
 ...
 // 1. index3_04_destructuring.html 
 // 2. js/app03_ds_event.js
